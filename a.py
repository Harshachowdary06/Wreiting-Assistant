#Created for Professor Jennifer Cohen by (yumaikas) Andrew Owen
#On 2/7/2012 COP-1000 class
#This program uses a Tkinter Canvas to display a clock that counts the time
