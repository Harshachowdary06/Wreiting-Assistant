...
def app():
    ...
    if st.button("check emotion in files"):
    ...
    # Taking words and respective emotions from emotions.txt file and storing in seperate lists
        emotions=open('apps/datasets/emotions.txt',encoding='utf-8').read()
    ...
    # Short forms and their full forms are in abrevations.txt
        abbreviations=open('apps/datasets/abbreviations.txt',encoding='utf-8').read()
    ...
    # Obtaining emotions and their sarcastic meanings in sarcastic_emotions.txt and storing in seperate variables
        ...
        sarcastic_emotion=[]
        opp_emotion=[]
        text1 = open("apps/datasets/sarcastic_emotions.txt", encoding="utf-8-sig").read()
        text2 =text1.split('\n')
        for word in text2:
            if i==0:
                i=1
    ...
    # Ploting a graph on the emotions
        ...
        plt.savefig('apps/datasets/graph.jpeg')
        image =  Image.open('apps/datasets/graph.jpeg')
